  ...
  return (
      <StyledTable
        ...
        <StyledThead
          ...
          <StyledTr>
            {th.map(
              (th: string, index: number): JSX.Element => {
                return (
                  <StyledTh
                    th={th}
                    key={index}
        ...
        <StyledTbody>
          <StyledTr>
            {row1.map(
              (row1: string, index: number): JSX.Element => {
                return (
                  <StyledTd
                    row1={row1}
                    key={index}
          ...
          <StyledTr>
            {row2.map(
              (row2: string, index: number): JSX.Element => {
                return (
                  <StyledTd
                    row2={row2}
                    key={index}
        ...
        <StyledTr>
            {footer.map(
              (footer: string, index: number): JSX.Element => {
                return (
                  <StyledTd
                    footer={footer}
                    key={index}
